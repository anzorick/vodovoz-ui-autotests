...
public class ProductPage extends BasePage {
     ...
     */
    @Step("Карточка товара загружена (H1 виден)")
    public ProductPage shouldBeLoaded() {
        log.info("Проверяю загрузку карточки товара...");
        productTitle.shouldBe(visible, Duration.ofSeconds(15));
        log.info("Карточка загружена: '{}'", productTitle.getText().trim());
        return this;
    }
